...
New-AzPolicyAssignment @params`,
  ...
  },
  {
    ...
    title: 'Windows Server 2025  Environment',
    icon: FaWindows,
    tagline: 'Nested Hyper-V simulating a multi-tier enterprise domain with AD, DHCP, and Group Policy.',
    category: 'Infrastructure',
    overview:
      'A fully isolated Windows Server 2025  built on a Hyper-V host with nested virtualization: a DC running AD DS and DNS/DHCP, a member server for file & IIS roles, and a Windows 11 client — all wired through an internal virtual switch. The  is used to validate GPO designs, new roles, and PowerShell automation before promoting changes to production.',
    problem:
  ...
  },
  {
    ...
    title: 'Active Directory Domain Design',
    icon: FaServer,
